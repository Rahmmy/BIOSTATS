...
```{r}
pheatmap::pheatmap(dune, clustering_distance_rows="euclidean", cluster_rows=FALSE, cluster_cols=FALSE,cellwidth=8,cellheight=10)
pheatmap::pheatmap(dune, clustering_distance_rows="euclidean",cluster_rows=TRUE, cluster_cols=TRUE)
```
