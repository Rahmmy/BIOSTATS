...
Outliers are extremly large counts
They arise through;
...
```{r}
Batch <- factor(c(1,2,2,1,1,2,2))
condition = factor(pasillaSampleAnno$condition, levels = c("untreated", "treated"))
design <- model.matrix(~ type + condition)
